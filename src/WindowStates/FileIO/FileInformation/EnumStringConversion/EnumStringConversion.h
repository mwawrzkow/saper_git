#ifndef SRC_WINDOWsTATES_FILEINFORMATION_ENUMSTRINGCONVERSION_H
#define SRC_WINDOWsTATES_FILEINFORMATION_ENUMSTRINGCONVERSION_H
#include <iostream>
#include <sstream>
#include <string>
#include <algorithm>

// https://codereview.stackexchange.com/users/507/martin-york
// Author of this code.
